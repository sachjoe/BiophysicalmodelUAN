...
NEURON {
        ...
        RANGE gbar, g, ina
        RANGE minf, mtau, hinf, htau, mtauna18, htauna18 
		THREADSAFE
}
...
UNITSOFF
		...
		mtau = mtauna18/(alpha_m+beta_m)			:Adapted from Han et al., 2015, Rat Nav .8 channel
		...
		htau = htauna18/(alpha_h+beta_h)			:Adapted from Han et al., 2015, Rat Nav 1.8 channel
